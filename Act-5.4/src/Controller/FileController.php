...
class FileController extends AbstractController
{
    ...
    {
        $r = $fileSystemImproved->createFile($file_name);
    ...
    {
        $r = $fileSystemImproved->deleteFile($file_name);
        return new JsonResponse($r);
    }
    ...
    {
        $r = $fileSystemImproved->writeInFile($file_name,$content,$offset);
        return new JsonResponse($r);
    }
    ...
    {
        $r = $fileSystemImproved->readFile($file_name);
        return new JsonResponse($r);
    }
